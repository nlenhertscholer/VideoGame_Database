...
DROP TABLE IF EXISTS engine_platforms;
DROP TABLE IF EXISTS game;
DROP TABLE IF EXISTS engine;
DROP TABLE IF EXISTS company;
DROP TABLE IF EXISTS platform;
DROP TABLE IF EXISTS country;
DROP TYPE IF EXISTS date_category;
DROP TYPE IF EXISTS platform_category;
...
-- Categories for the type of platform
...
CREATE TABLE platform(
  ...
  category_id INT REFERENCES platform_category(category_id),
  generation INT
);

-- Format of date for the release date
--CREATE TYPE date_category AS ENUM(
--  'YYYYMMMMDD',
--  'YYYYMMMM',
--  'YYYY',
--  'YYYYQ1',
...
CREATE TABLE release_dates(
  ...
  game_id INT REFERENCES game(game_id),
  rel_date BIGINT,
  category_id INT REFERENCES date_category(category_id),
